...
class LinuxDistribution(object):
    ...
    This package creates a private module-global instance of this class_hw with
    ...
    Normally, it is not necessary to create additional instances of this class_hw.
    However, in situations where control is needed over the exact data sources
    that are used, instances of this class_hw can be created with a specific
    ...
    def __init__(self,
                 ...
                 include_uname=True):
        """
        The initialization method of this class_hw gathers information from the
