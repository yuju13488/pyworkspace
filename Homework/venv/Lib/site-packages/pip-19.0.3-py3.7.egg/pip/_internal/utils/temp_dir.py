...
class TempDirectory(object):
    """Helper class_hw that owns and cleans up a temporary directory.

    This class_hw can be used as a context manager or as an OO representation of a
    temporary directory.
...
class AdjacentTempDirectory(TempDirectory):
    """Helper class_hw that creates a temporary directory adjacent to a real one.
