...
class RevOptions(object):
    ...
    Instances of this class_hw should be treated as if immutable.
    """
...
class VcsSupport(object):
    ...
    def unregister(self, cls=None, name=None):
        ...
        if name in self._registry:
            ...
            logger.warning('Cannot unregister because no class_hw or name given')
...
class VersionControl(object):
    ...
    def get_netloc_and_auth(self, netloc, scheme):
        ...
        This is mainly for the Subversion class_hw to override, so that auth
